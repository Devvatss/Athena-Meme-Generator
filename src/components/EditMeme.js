    ...
    return (
        <Grid container style={{paddingTop: "24px", }}>
            ...
            <Grid item xs={12} sm={10}>
                <Card variant="outlined" style={{backgroundColor:"#C0C0C0"}}>
                    ...
                    <CardContent>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={6}>
                                <Typography variant="body1">Enter details:</Typography>
            ...
            <Dialog scroll="body" fullScreen open={open} onClose={modalClose}>
                ...
                <DialogContent className={classes.dialogContent}>
                    ...
                    <a style={{textDecoration: "none"}} href={generatedMeme} download>
                        <Button style={{width: "100%", margin: "10px 0"}} variant="outlined" color="primary">Download Meme</Button>
                    </a>
                </DialogContent>
            </Dialog>
        </Grid>
